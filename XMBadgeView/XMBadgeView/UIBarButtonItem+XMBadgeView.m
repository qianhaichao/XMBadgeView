...
#import "UIBarButtonItem+XMBadgeView.h"

@implementation UIBarButtonItem (XMBadgeView)
...
- (UIView *)getView
{
    ...
    NSString *controlName = systemVersion < 11.0 ? @"UIImageView" : @"UIButton";
